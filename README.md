...
* [GitHub Repository](https://github.com/directus/directus) ⭐ 37,456 | 🐛 387 | 🌐 TypeScript | 📅 2026-08-18
* [Community Help Board](https://github.com/directus/directus/discussions/categories/q-a) ⭐ 37,456 | 🐛 387 | 🌐 TypeScript | 📅 2026-08-18
...
* [react-directus](https://github.com/gremo/react-directus) ⭐ 135 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-18 - A set of React components and utilities for Directus Headless CMS.
...
* [cool-stack](https://github.com/tdsoftpl/cool-stack) ⭐ 35 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-15 - Template repository integrating Directus & Remix into a full-stack monorepo.
...
* [WordPress-like Slug](https://github.com/dimitrov-adrian/directus-extension-wpslug-interface) ⭐ 100 | 🐛 12 | 🌐 Vue | 📅 2024-07-22 - Slug/Permalink interface with support for pre- and suffixes.
...
* [Directus Mailer](https://github.com/ryntab/Directus-Mailer) ⭐ 46 | 🐛 0 | 🌐 JavaScript | 📅 2024-10-13 - An endpoint for sending emails with the Directus Nodemailer service.
...
* [Imagga Hook](https://github.com/gbicou/directus-extension-imagga) ⭐ 16 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-14 - Hook for file uploads to automatically tag images with [Imagga API](https://imagga.com/).
...
* [Tab Group](https://github.com/formfcw/directus-extension-tab-group) ⭐ 14 | 🐛 0 | 🌐 Vue | 📅 2024-09-17 - A group interface with a tab menu for toggling the visibility of fields within the group.
...
* [Auto generate file transformations](https://github.com/utomic-media/directus-extension-auto-generate-file-transformations) ⭐ 6 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-27 - Automatically generate selected file transformations on upload
...
* [Agency OS](https://github.com/directus-community/agency-os) ⭐ 964 | 🐛 23 | 🌐 Vue | 📅 2026-03-06 - Fully complete, opinionated agency website template featuring Nuxt and Directus. View [Demo](https://www.agencyos.dev/).
